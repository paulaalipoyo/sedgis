                            ...
                            <Col lg="6">
                                <div className="pr-5">
                                    ...
                                    <h2 className="display-4 text-white font-weight-light">
                                        A beautiful premium dashboard for
                                        Bootstrap 4, React and Reactstrap.
                                    </h2>
                                    <p className="text-white mt-4">
                                        Argon perfectly combines reusable HTML
                                        and modular CSS with a modern styling
                                        and beautiful markup throughout each
                                    ...
                                    <Col className="pt-lg-5 pt-4" md="6">
                                        <Card className="mb-4">
                                            <CardBody>
                                                ...
                                                <p>
                                                    From simple to complex, you
                                                    get a beautiful set of 15+
                                                    page examples.
                                                </p>
                                            </CardBody>
                                        </Card>
