...
function Production() {
    ...
    const getSubIndicators = () => {
        axios
            .get(
                `${REACT_APP_API_URL}/production-sub-indicators.php/subindicators`
            )
            .then((response) => {
                const { data } = response;
                if (response.status === 200) {
    ...
    function getUserId(id) {
        axios
            .get(
                `${REACT_APP_API_URL}/production.php/rsep_production/${id}`
            )
    ...
    function getProduction() {
        axios
            .get(
                `${REACT_APP_API_URL}/production.php/rsep_production`
            )
            .then(function (response) {
                console.log(response.data);
    ...
    const addHandleSubmit = () => {
        axios
            .post(
                `${REACT_APP_API_URL}/production.php/production/save`,
                inputs
            )
            .then(function (response) {
                console.log(response.data);
                getProduction(response.data);
            });
    };
            ...
            <ReactBSAlert
                ...
                onConfirm={() => {
                    getProduction(
                        axios
                            .delete(
                                `${REACT_APP_API_URL}/production.php/${id}/delete`
                            )
                            .then(function (response) {
                                console.log(response.data);
                                getProduction(response.data);
