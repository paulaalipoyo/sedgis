...
function IncomeStatement() {
    ...
    function getUserId(id) {
        axios
            .get(
                `${REACT_APP_API_URL}/income-statement.php/incomestatement/${id}`
            )
    ...
    function getIncomeStatement() {
        axios
            .get(`${REACT_APP_API_URL}/income-statement.php/incomestatement`)
            .then(function (response) {
                console.log(response.data);
    ...
    const addHandleSubmit = () => {
        axios
            .post(
                `${REACT_APP_API_URL}/income-statement.php/incomestatement/save`,
                inputs
            )
            .then(function (response) {
                console.log(response.data);
                getIncomeStatement(response.data);
            });
    };
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry Updated on Income Statement
                    </span>
                </div>
            ),
            type: type,
        ...
        let options = {
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry Added on Income Statement
                    </span>
                </div>
            ),
            type: type,
        ...
        let options = {
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry deleted from Income Statement
                    </span>
                </div>
            ),
            type: type,
            ...
            <ReactBSAlert
                ...
                onConfirm={() => {
                    getIncomeStatement(
                        axios
                            .delete(
                                `${REACT_APP_API_URL}/income-statement.php/${id}/delete`
                            )
                            .then(function (response) {
                                console.log(response.data);
                                getIncomeStatement(response.data);
    ...
    const onAfterSaveCell = (id) => {
        axios
            .put(
                `${REACT_APP_API_URL}/income-statement.php/incomestatement/${id}/edit`
            )
            .then(function (response) {
                console.log(response.data);
            });
                        ...
                        <Card>
                            <CardHeader className="border-0">
                                <Row>
                                    <Col xs="6">
                                        <h3 className="mb-0">
                                            Statement of Income of Municipal
                                            Goverments by Province / City
                                        </h3>
                                    </Col>
                ...
                <div className="modal-body">
                    <Form>
                        <FormGroup className="row">
                            ...
                            <Col md="10">
                                <Input
                                    defaultValue="Statement of income of Municipal Governments by Province / City"
                                    id="indicators"
                                    name="indicators"
                                    type="text"
                                    disabled
