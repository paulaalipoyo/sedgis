...
function Employment() {
    ...
    const getSubIndicators = () => {
        axios
            .get(
                `${REACT_APP_API_URL}/employment-sub-indicators.php/subindicators`
            )
            .then((response) => {
                const { data } = response;
                if (response.status === 200) {
    ...
    function getUserId(id) {
        axios
            .get(
                `${REACT_APP_API_URL}/employment.php/rsep_employments/${id}`
            )
    ...
    function getEmployments() {
        axios
            .get(
                `${REACT_APP_API_URL}/employment.php/rsep_employments`
            )
            .then(function (response) {
                console.log(response.data);
    ...
    const addHandleSubmit = () => {
        axios
            .post(
                `${REACT_APP_API_URL}/employment.php/employment/save`,
                inputs
            )
            .then(function (response) {
                console.log(response.data);
                getEmployments(response.data);
            });
    };
            ...
            <ReactBSAlert
                ...
                onConfirm={() => {
                    getEmployments(
                        axios
                            .delete(
                                `${REACT_APP_API_URL}/employment.php/${id}/delete`
                            )
                            .then(function (response) {
                                console.log(response.data);
                                getEmployments(response.data);
