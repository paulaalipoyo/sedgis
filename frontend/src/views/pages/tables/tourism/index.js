...
function Tourism() {
    ...
    const getSubIndicators = () => {
        axios
            .get(
                `${REACT_APP_API_URL}/tourism-sub-indicators.php/subindicators`
            )
            .then((response) => {
                const { data } = response;
                if (response.status === 200) {
    ...
    function getUserId(id) {
        axios
            .get(
                `${REACT_APP_API_URL}/tourism.php/rsep_tourism/${id}`
            )
    ...
    function getTourism() {
        axios
            .get(
                `${REACT_APP_API_URL}/tourism.php/rsep_tourism`
            )
            .then(function (response) {
                console.log(response.data);
    ...
    const addHandleSubmit = () => {
        axios
            .post(
                `${REACT_APP_API_URL}/tourism.php/tourism/save`,
                inputs
            )
            .then(function (response) {
                console.log(response.data);
                getTourism(response.data);
            });
    };
            ...
            <ReactBSAlert
                ...
                onConfirm={() => {
                    getTourism(
                        axios
                            .delete(
                                `${REACT_APP_API_URL}/tourism.php/${id}/delete`
                            )
                            .then(function (response) {
                                console.log(response.data);
                                getTourism(response.data);
