...
function GrdpIndustry() {
    const [addModalshow, setAddModal] = React.useState(false);
    const [alert, setalert] = React.useState(false);
    const [grdpindustry, setGrdpIndustry] = useState([]);
    ...
    const getUnits = () => {
        axios
            .get(`${REACT_APP_API_URL}/grdp-industry-unit.php/units`)
            .then((response) => {
                const { data } = response;
                if (response.status === 200) {
                    //check the api call is success by stats code 200,201 ...etc
    ...
    const getSubIndicators = () => {
        axios
            .get(
                `${REACT_APP_API_URL}/grdp-industry-sub-indicators.php/subindicators`
            )
            .then((response) => {
                const { data } = response;
                if (response.status === 200) {
    ...
    function getUserId(id) {
        axios
            .get(`${REACT_APP_API_URL}/grdp-industry.php/perindustry/${id}`)
    ...
    function getGrdpIndustry() {
        axios
            .get(`${REACT_APP_API_URL}/grdp-industry.php/perindustry`)
            .then(function (response) {
                console.log(response.data);
                setGrdpIndustry(response.data);
            });
    }
    ...
    const addHandleSubmit = () => {
        axios
            .post(
                `${REACT_APP_API_URL}/grdp-industry.php/perindustry/save`,
                inputs
            )
            .then(function (response) {
                console.log(response.data);
                getGrdpIndustry(response.data);
            });
    };
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry Updated on GRDP per Industry
                    </span>
                </div>
            ),
            type: type,
        ...
        let options = {
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry Added on GRDP per Industry
                    </span>
                </div>
            ),
            type: type,
        ...
        let options = {
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry deleted from GRDP per Industry
                    </span>
                </div>
            ),
            type: type,
            ...
            <ReactBSAlert
                ...
                onConfirm={() => {
                    getGrdpIndustry(
                        axios
                            .delete(
                                `${REACT_APP_API_URL}/grdp-industry.php/${id}/delete`
                            )
                            .then(function (response) {
                                console.log(response.data);
                                getGrdpIndustry(response.data);
    ...
    const onAfterSaveCell = (id) => {
        axios
            .put(
                `${REACT_APP_API_URL}/grdp-industry.php/perindustry/${id}/edit`
            )
            .then(function (response) {
                console.log(response.data);
            });
                        ...
                        <Card>
                            <CardHeader className="border-0">
                                <Row>
                                    <Col xs="6">
                                        <h3 className="mb-0">
                                            Gross Regional Domestic Product by
                                            Industry
                                        </h3>
                                    </Col>
                ...
                <div className="modal-body">
                    <Form>
                        <FormGroup className="row">
                            ...
                            <Col md="10">
                                <Input
                                    defaultValue="Gross Regional Domestic Product by Industry"
                                    id="indicators"
                                    name="indicators"
                                    type="text"
                                    disabled
