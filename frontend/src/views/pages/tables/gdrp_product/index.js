...
function GrdpCapita() {
    ...
    const [grdpcapita, setGrdpCapita] = useState([]);
    ...
    const getSubIndicators = () => {
        axios
            .get(
                `${REACT_APP_API_URL}/grdp-capita-sub-indicators.php/subindicators`
            )
            .then((response) => {
                const { data } = response;
                if (response.status === 200) {
    ...
    function getUserId(id) {
        axios
            .get(`${REACT_APP_API_URL}/grdp-capita.php/percapita/${id}`)
    ...
    function getGrdpCapita() {
        axios
            .get(`${REACT_APP_API_URL}/grdp-capita.php/percapita`)
            .then(function (response) {
                console.log(response.data);
                setGrdpCapita(response.data);
            });
    }

    const addHandleSubmit = () => {
        axios
            .post(`${REACT_APP_API_URL}/grdp-capita.php/percapita/save`, inputs)
            .then(function (response) {
                console.log(response.data);
                getGrdpCapita(response.data);
            });
    };
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry Updated on GRDP per Capita
                    </span>
                </div>
            ),
            type: type,
        ...
        let options = {
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry Added on GRDP per Capita
                    </span>
                </div>
            ),
            type: type,
        ...
        let options = {
            ...
            message: (
                <div className="alert-text">
                    ...
                    <span data-notify="message">
                        Entry deleted from GRDP per Capita
                    </span>
                </div>
            ),
            type: type,
            ...
            <ReactBSAlert
                ...
                onConfirm={() => {
                    getGrdpCapita(
                        axios
                            .delete(
                                `${REACT_APP_API_URL}/grdp-capita.php/${id}/delete`
                            )
                            .then(function (response) {
                                console.log(response.data);
                                getGrdpCapita(response.data);
    ...
    const onAfterSaveCell = (id) => {
        axios
            .put(`${REACT_APP_API_URL}/grdp-capita.php/percapita/${id}/edit`)
            .then(function (response) {
                console.log(response.data);
            });
                ...
                <div className="modal-body">
                    <Form>
                        <FormGroup className="row">
                            ...
                            <Col md="10">
                                <Input
                                    defaultValue="Per Capita Gross Regional Domestic Product"
                                    id="indicators"
                                    name="indicators"
                                    type="text"
                                    disabled
