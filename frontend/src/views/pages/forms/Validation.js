                                    ...
                                    <Row>
                                        <Col lg="8">
                                            <p className="mb-0">
                                                ...
                                                novalidate boolean attribute to
                                                your <code>{`<form>`}</code>.
                                                This disables the browser
                                                default feedback tooltips, but
                                                still provides access to the
                                                form validation APIs in
                                                JavaScript. <br />
                                                <br />
                                                When attempting to submit,
                                                you’ll see the{' '}
                                                <code>:invalid</code> and{' '}
                                                <code>:valid</code> styles
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <Row>
                                        <Col lg="8">
                                            <p className="mb-0">
                                                Not interested in custom
                                                validation feedback messages or
                                                writing JavaScript to change
                                                form behaviors? All good, you
                                                can use the browser defaults.
                                                Try submitting the form below.
                                                Depending on your browser and
                                                OS, you’ll see a slightly
                                                different style of feedback.{' '}
                                                <br />
                                                <br />
                                                While these feedback styles
                                                cannot be styled with CSS, you
                                                can still customize the feedback
                                    ...
                                    <Row>
                                        <Col lg="8">
                                            <p className="mb-0">
                                                ...
                                                validation, but in case you
                                                require server side, you can
                                                indicate invalid and valid form
                                                fields with{' '}
                                                <code>.is-invalid</code> and{' '}
                                                <code>.is-valid</code>. Note
                                                that{' '}
